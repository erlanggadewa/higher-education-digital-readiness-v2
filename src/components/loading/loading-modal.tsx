...
function LoadingModal() {
  return (
    <>
      <div className="fixed bottom-0 left-0 right-0 top-0 z-50 flex items-center justify-center rounded-md bg-opacity-10 shadow-lg backdrop-blur-lg backdrop-filter lg:left-[260px]">
