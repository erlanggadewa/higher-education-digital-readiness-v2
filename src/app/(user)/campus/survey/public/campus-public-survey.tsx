...
async function CampusPublicSurvey() {
  ...
  console.log('🚀 ~ CampusPublicSurvey ~ data:', data);
  ...
  return (
    <div>
      ...
      <div className="panel -mt-16">
        ...
        <p className="mb-3">Daftar survei yang dapat dikerjakan oleh pengguna, berdasarkan tipe pengguna yang sudah ditentukan</p>
