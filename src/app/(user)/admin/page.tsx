  ...
  return (
    <div className={cn('w-full max-w-[19rem] rounded-lg border border-[#e0e6ed] shadow-[4px_6px_10px_-3px_#bfc9d4] dark:border-none dark:shadow-none', color)}>
      <div className="flex items-center gap-4 p-6">
        <div className="rounded-xl bg-white p-2">{icon}</div>
  ...
  return (
    <>
      ...
      <div className="flex justify-between">
        ...
        <div>
          <button type="button" className="btn bg-white dark:border-[#1b2e4b] dark:bg-[#191e3a] dark:shadow-none">
            Respon Pertanyaan
          </button>
        </div>
      </div>
      ...
      <div className="mb-5 flex gap-3">
        <CardDashboard
          icon={<IconCertificate className="h-10 w-10 text-sky-700" />}
          color="bg-gradient-to-r from-sky-600 to-sky-500 text-white shadow-md dark:from-sky-800 dark:to-sky-700"
          count={6}
          label="Telah Mengisi"
        />
